/*
-- check big screen
-- for folder links make sure ../ is used
-- the nav page is tricky, and that's where i will need the absolute paths or to find a way around it.
...
let sourceImgArr = ['images/album_covers/glass.png', 'images/album_covers/jack.png','images/album_covers/discon.png', 'images/album_covers/ego.png', 'images/album_covers/george.png', 'images/album_covers/L.png', 'images/branding/crow.png', 'images/star_square.png', 'images/branding/aymee.png', 'images/logos/orb.png','images/Merch/sticker design.jpg', 'images/album_covers/contours.png' ];
...
footerTag.forEach(foot => {
  ...
  logoLink.href = "graphic design.html";

  const logoImg = document.createElement('img');
  logoImg.loading = "lazy";
  logoImg.src = "images/logos/sh logo.png";
  ...
  const links = [
    { text: 'Home', href: 'index.html', aria: 'Go to home page' },
    { text: 'Contact', href: 'contact.html', aria: 'Go to contact page' },
    { text: 'About', href: 'about.html', aria: 'Go to about page' },
  ...
  foot.appendChild(container);
    ...
    navArray = [
      {
        menu: true,
        link: 'images/svg/bars%20white.svg'
      },
      {name: 'Home',
      link: 'index.html',
      ...
      {name: 'Digital Art & Branding',
        ...
        {name: 'Snoozecrow',
          link: 'branding/snoozecrow.html',
          aria: 'Go to the snoozecrow cartoon vector art page'
          },
        {name: 'Nouveau Star',
          link: 'branding/star.html',
